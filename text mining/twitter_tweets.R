...
# twitter extraction 
tweets_ext <-userTimeline("elonmusk",n=1000)
tweets_df <- twListToDF(tweets_ext)
write.csv(tweets_df,"elonmusk.csv")
getwd()
...
#stemming is not considered by me for this user
...
findAssocs(doctm,terms ="tesla",corlimit =0.3)
head(df,10)
...
#Tesla is most used term by Elonmusk (CEO and co-founder of Tesla)
